...
export_allowed_ark_env_pair() {
  ...
  case "$_key" in
    ...
    ARK_EMBEDDING_BACKEND) ARK_EMBEDDING_BACKEND="$_value"; export ARK_EMBEDDING_BACKEND ;;
    ARK_EMBEDDING_MODEL) ARK_EMBEDDING_MODEL="$_value"; export ARK_EMBEDDING_MODEL ;;
    ARK_EMBEDDING_MODEL_PATH) ARK_EMBEDDING_MODEL_PATH="$_value"; export ARK_EMBEDDING_MODEL_PATH ;;
    ARK_EMBEDDING_DIMENSIONS) ARK_EMBEDDING_DIMENSIONS="$_value"; export ARK_EMBEDDING_DIMENSIONS ;;
    ARK_EMBEDDING_BATCH_SIZE) ARK_EMBEDDING_BATCH_SIZE="$_value"; export ARK_EMBEDDING_BATCH_SIZE ;;
    ARK_EMBEDDING_NORMALIZE) ARK_EMBEDDING_NORMALIZE="$_value"; export ARK_EMBEDDING_NORMALIZE ;;
    ARK_EMBEDDING_DEVICE) ARK_EMBEDDING_DEVICE="$_value"; export ARK_EMBEDDING_DEVICE ;;
    ARK_EMBEDDING_ALLOW_NETWORK) ARK_EMBEDDING_ALLOW_NETWORK="$_value"; export ARK_EMBEDDING_ALLOW_NETWORK ;;
