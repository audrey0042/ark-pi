...
Future one-line bootstrap: [install.sh](../install.sh) bootstraps the app (clone, venv, data dirs). Service install still manual. Spec: [installer-bootstrap-contract.md](deployment/installer-bootstrap-contract.md).
