...
Right now you deploy by hand: [two-pi-manual.md](two-pi-manual.md). [install.sh](../../install.sh) can install apt-based OS prerequisites, bootstrap the app, render templates, validate installs, and install service files with `--install-services`. Full Pi setup: [roadmap §36](../roadmap.md#36-installer-bootstrap).

| Doc | |
|-----|--|
| [two-pi-manual.md](two-pi-manual.md) | Manual ark-rag / ark-llm setup (current path) |
| [installer-bootstrap-contract.md](installer-bootstrap-contract.md) | Installer contract; OS packages + app bootstrap + validation live |
